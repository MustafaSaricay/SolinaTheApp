/**
 * tests/calculator.test.js — Unit tests for services/calculator.js
 *
 * Identical logic to the original electron tests; adapted to import from
