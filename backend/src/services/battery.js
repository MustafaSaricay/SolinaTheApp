/**
 * services/battery.js — Wraps systeminformation to get battery data cross-platform.
 *
 * Identical to electron/battery.js; extracted into the backend service layer.
 */
